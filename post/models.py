...
class JobPostSkillSet(models.Model):
    skill_set = models.ForeignKey(
        'SkillSet', on_delete=models.SET_NULL, null=True)
    job_post = models.ForeignKey(
        'JobPost', on_delete=models.SET_NULL, null=True)
...
class Company(models.Model):
    ...
    business_area = models.ManyToManyField(
        'BusinessArea', through='CompanyBusinessArea')
...
class CompanyBusinessArea(models.Model):
    ...
    business_area = models.ForeignKey(
        'BusinessArea', on_delete=models.SET_NULL, null=True)
...
class Volunteer(models.Model):
    volunteer_companyname = models.CharField(max_length=128)

    class Meta:
        db_table = 'volunteer_companyname'
